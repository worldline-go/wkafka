...
func (h *Handler) SkipList(ctx context.Context, req *connect.Request[emptypb.Empty]) (*connect.Response[wkafkahandler.SkipListResponse], error) {
	...
	return connect.NewResponse(&wkafkahandler.SkipListResponse{
		Skip: skipList,
	}), nil
}
